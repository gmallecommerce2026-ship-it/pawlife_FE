        ...
        useCallback(() => {
            const fetchPetDetail = async () => {
                ...
                try {
                    ...
                    console.error(isVi ? "Lỗi khi tải thông tin thú cưng:" : "Error loading pet information:", error);
                } finally {
                    setIsLoading(false);
                }
            };
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                        ...
                        <View className="flex-row items-center flex-1">
                            ...
                            <View className="ml-3 flex-1 pr-4">
                                ...
                                <Text className="text-[13px] text-[#8E8E93] font-normal mt-0.5" numberOfLines={1}>
                                    {petData?.shelter?.address || (isVi ? 'chưa cập nhật địa chỉ' : 'address not updated')}
                                </Text>
                            </View>
                        </View>
                        {petData?.shelter?.id && (
                    ...
                    <View className="px-[25px] mt-[30px]">
                        ...
                        <Text className="text-[14px] text-[#8E8E93] leading-[22px] font-normal">
                            {petData?.description || isVi ? "Hiện chưa có thông tin mô tả chi tiết cho bé." : "There is currently no detailed description available for the baby."}
                        </Text>
