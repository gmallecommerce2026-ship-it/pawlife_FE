      ...
      <SafeAreaView className="flex-1" edges={['top', 'bottom']}>
        ...
        <View className="flex-row items-center px-4 py-2 mb-2 relative bg-white pb-4">
          ...
          <View className="absolute left-0 right-0 items-center justify-center pointer-events-none">
            <Text className="text-[24px] font-semibold text-black">Privacy Policy</Text>
          </View>
        </View>

        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
            <View className="bg-white p-5 rounded-[30px] shadow-md border border-gray-100">
                <Text className="text-sm font-medium text-gray-500 mb-6 italic">
                    Effective Date: [1 January 2025]
                </Text>

                <View className="mb-4">
                    <Text className="text-base font-semibold text-gray-900 mb-2">1. Information Collection</Text>
                ...
                <View className="mb-4">
                    <Text className="text-base font-semibold text-gray-900 mb-2">2. Use of Information</Text>
                    <Text className="text-sm text-gray-600 leading-6">
                ...
                <View className="mb-4">
                    <Text className="text-base font-semibold text-gray-900 mb-2">3. Disclosure of Information</Text>
                    <Text className="text-sm text-gray-600 leading-6">
                ...
                <View className="mb-4">
                    <Text className="text-base font-semibold text-gray-900 mb-2">4. Security</Text>
                    <Text className="text-sm text-gray-600 leading-6">
                ...
                <View className="mb-4">
                    <Text className="text-base font-semibold text-gray-900 mb-2">5. Your Rights</Text>
                    <Text className="text-sm text-gray-600 leading-6">
                ...
                <View className="mb-2">
                    <Text className="text-base font-semibold text-gray-900 mb-2">6. Changes to This Privacy Policy</Text>
                    <Text className="text-sm text-gray-600 leading-6">
                ...
                <TouchableOpacity 
                    ...
                    activeOpacity={0.8}
                    className="w-full mt-10 bg-[#E89B5A] py-3.5 rounded-xl shadow-sm items-center flex-row justify-center"
                >
