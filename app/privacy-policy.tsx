...
export default function PrivacyPolicyScreen() {
  ...
  const handleOpenWebPolicy = () => {
    Linking.openURL('https://elfin-pajama-4bb.notion.site/CH-NH-S-CH-B-O-M-T-PAWLIFE-36c6c8475df680fa8064e7ebf82d0933?pvs=73');
  };
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
            <View className="bg-white p-5 rounded-[24px] shadow-sm border border-gray-100">
                ...
                <View className="mb-6">
                    ...
                    <BulletPoint title={t("User content")} text={t("community posts, comments, adoption registration information, and pet exchanges.")} />
